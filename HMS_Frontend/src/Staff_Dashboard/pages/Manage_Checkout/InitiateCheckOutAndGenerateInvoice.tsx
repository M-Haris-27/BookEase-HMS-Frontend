...
export default function InitiateCheckOutAndGenerateInvoice() {
  ...
  const fetchBookings = async () => {
    ...
    try {
      ...
      const filteredBookings = newData.filter(
        (booking) => booking.bookingStatus !== 'CANCELLED' && booking.bookingStatus !== 'CHECKED_OUT',
      );
                    ...
                    <ul className="list-none ml-0">
                      ...
                      <Dialog>
                        <DialogTrigger asChild>
                          ...
                          <CheckOutDialog bookingId = {booking.bookingId} />
                      </Dialog>
                    </ul>
                  </li>
                </ul>
