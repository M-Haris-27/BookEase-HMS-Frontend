...
export default function RegisterGuest () {
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const response = await fetch(`https://${apiUrl}/guest/registerGuest`, {
        method: 'POST',
        headers: {
      ...
      toast.error('An error occurred while registering the guest.', {
        position: 'bottom-right',
        autoClose: 4000,
        hideProgressBar: false,
        closeOnClick: true,
  ...
  return (
    <>
      <section className="bg-gray-50 dark:bg-boxdark w-[600px]">
        <div className="flex mt-18 flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
