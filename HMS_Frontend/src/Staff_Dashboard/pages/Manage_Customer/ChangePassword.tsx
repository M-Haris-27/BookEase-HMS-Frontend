...
const ChangePassword = () => {
  ...
  const validateData = (data: any) => {
    ...
    if(data.guestID <= 0){
      toast.error('Invalid Guest ID Provided', {
        position: 'bottom-right',
        autoClose: 4000,
        hideProgressBar: false,
        closeOnClick: true,
                ...
                <ul>
                  ...
                  <li>
                    <p className="dark:text-white text-boxdark">
                      1. Verify customer identity before changing the password or creating an account to prevent unauthorized access.
                    </p>
                  </li>
                  <br />
                  <li>
                    <p className="dark:text-white text-boxdark">
                      2. Ensure the new password is strong, containing a mix of letters, numbers, and special characters, and inform the customer not to reuse previous passwords.
                    </p>
                  </li>
                </ul>
              </li>
